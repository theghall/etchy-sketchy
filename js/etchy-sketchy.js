...
//                Fixed calculation of px size for squareClass
//
...
function initGrid(gridSize) {
  ...
  // Adjust height and width of DIV elements based on gridSize.  Round down to nearest tenth
  var squarePixelSize = Math.floor((containerSize / gridSize) * 10) / 10;
